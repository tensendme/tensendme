            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row ml-1 mt-2">
                        <div class="col-3">
                            <label class="form-control-plaintext" for="host_user_id">Пользователь</label>
                            <select id="user_id" class="form-control search js-example-basic-single" name="balance_id"></select>
                        </div>
                        <div class="col-3">
                            <label for="subscription_type_id" class="form-control-plaintext">Тип истории</label>
                            <select class="form-control search" id="type_id" type="text" name="history_type_id">
                        ...
                        <div class="col-3">
                            <label for="actual_price" class="form-control-plaintext">Сумма</label>
                            <input class="form-control search" type="number" min="0" id="price"
                                   name="amount" placeholder="9900">
                        </div>
                        <div class="col-3">
...
{{--                        </div>--}}
                        ...
                        <div class="col-3">
                            <label for="datemax" class="form-control-plaintext">Записан до</label>
        ...
        <div class="col">
            <div class="card card-small mb-4">
                ...
                <div id="filterTable">
                    @include('admin.userActions.histories.table')
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script>
        ...
        function search() {
            var query = filter();
            fetch('{{route('history.filter')}}?' + query)
        ...
        var nextLink = '/users/balance/select';
        var term = '';
