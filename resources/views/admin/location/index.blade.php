        ...
        <div class="col">
            <div class="card card-small mb-4">
                <div class="card-header border-bottom">
                    <h6 class="m-0">Локации</h6>
                </div>
                <div class="card-header border-bottom">
                    <a href="{{route('location.create')}}" type="button" class="mb-2 btn btn-medium btn-primary mr-1">Добавить
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline-primary mb-2 "
                                       href="{{route('location.edit', ['id' => $location->id])}}">
