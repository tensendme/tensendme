        ...
        <div class="col">
            <div class="card card-small mb-4">
                <div class="card-header border-bottom">
                    ...
                    <h6 class="m-0">Редактирование FAQ</h6>
                </div>
                <div class="card-body p-2 pb-4 text-center">
                    <img src="{{asset('images/'.$faq->image_path)}}" style="width: 300px; height: 280px">
                    <form method="post" action="{{route('faq.update', ['id' => $faq->id])}}" enctype="multipart/form-data">
