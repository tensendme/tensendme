...
<script>
    function submitForm() {
        ...
        myHeaders.append("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC8xMjcuMC4wLjE6ODAwMFwvYXBpXC92MVwvbG9naW4iLCJpYXQiOjE1ODE2Nzg1OTMsImV4cCI6MTU4MTkzNzc5MywibmJmIjoxNTgxNjc4NTkzLCJqdGkiOiJlenl3ZEZZak9CdWlvRFZIIiwic3ViIjoxLCJwcnYiOiJlZTVhYzY5NDI5YzU1NmQ3NWRiZTdmZjRlNThiOTdjZDRmNzE0MmViIn0.HRVfuDhmotpun9D1q_DItAnkbJCze8j1DHoE0b6WmVA");
...
{{--            <input type="number" id="card-number" onkeyup="putIntoCardNumber()" class="input-cart-number" value="5169"--}}
{{--                   maxlength="4"/>--}}
{{--            <input type="number" id="card-number-1" onkeyup="putIntoCardNumber()" class="input-cart-number" value="4931"--}}
{{--                   maxlength="4"/>--}}
{{--            <input type="number" id="card-number-2" onkeyup="putIntoCardNumber()" class="input-cart-number" value="3732"--}}
{{--                   maxlength="4"/>--}}
{{--            <input type="number" id="card-number-3" onkeyup="putIntoCardNumber()" class="input-cart-number" value="7758"--}}
{{--                   maxlength="4"/>--}}
{{--        </fieldset>--}}
{{--        <fieldset>--}}
{{--            <label for="card-holder">Card holder</label>--}}
{{--            <input type="text" id="card-holder" value="DAUREN KAKIMBEKOV" data-cp="name"/>--}}
{{--        </fieldset>--}}
...
{{--            <input type="text" id="card-ccv" data-cp="cvv" value="492" maxlength="3"/>--}}
{{--        </fieldset>--}}
{{--        --}}{{--        <button class="btn"><i class="fa fa-lock" onclick="getFormData()"></i> submit</button>--}}
{{--        <button class="btn" onclick="putIntoCardNumber();createCryptogram()">submit</button>--}}
...
{{--        <input type="hidden" name="TermUrl" value="http://192.168.0.115.:8000/api/v1/3d/secure">--}}
{{--    </form>--}}
{{--</div>--}}
{{--<div class="card-body p-0 pb-3 text-center">--}}
...
{{--            var user = "pk_5ca541f82448e11afb98b5c1a3ffa";--}}
{{--            var pass = "cc06d6b7614d4834809dfdd755527f1a";--}}
...
{{--            var myHeaders = new Headers();--}}
{{--            myHeaders.append("Content-Type", "application/json");--}}
{{--            myHeaders.append("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC8xMjcuMC4wLjE6ODAwMFwvYXBpXC92MVwvbG9naW4iLCJpYXQiOjE1ODEwNjc1OTgsImV4cCI6MTU4MTA3MTE5OCwibmJmIjoxNTgxMDY3NTk4LCJqdGkiOiJyWktIUGM1b0sxOXB0ZU42Iiwic3ViIjoxLCJwcnYiOiJlZTVhYzY5NDI5YzU1NmQ3NWRiZTdmZjRlNThiOTdjZDRmNzE0MmViIn0.KjN69wkGJJxkfHGJumhZ6rlhFA0UpApKSCC0llKQL-o");--}}

{{--            var raw = JSON.stringify({"Amount":"{{$subscription_type->price}}","Name":"DAUREN KAKIMBEKOV","CardCryptogramPacket":result.packet,"ubscription_type_id":"{{$subscription_type->id}}"});--}}
...
{{--        form.setAttribute("name", "daur");--}}
{{--        form.setAttribute("type", "hidden");--}}
{{--        form.setAttribute("action", "https://demo.cloudpayments.ru/acs");--}}
{{--        form.setAttribute("method", "POST");--}}
...
{{--        input1.setAttribute("name", "MD");--}}
{{--        input1.setAttribute("type", "hidden");--}}
{{--        input1.setAttribute("value", "value_you_want");--}}
{{--        var input2 = document.createElement("input");--}}
{{--        input2.setAttribute("name", "PaReq");--}}
{{--        input2.setAttribute("type", "hidden");--}}
{{--        input2.setAttribute("value", "value_you_want");--}}
{{--        var input3 = document.createElement("input");--}}
{{--        input3.setAttribute("name", "TermUrl");--}}
{{--        input3.setAttribute("type", "hidden");--}}
{{--        input3.setAttribute("value", "value_you_want");--}}
